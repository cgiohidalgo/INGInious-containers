...
class JSProjectFactory(ProjectFactory):
    """
    Implementation of ProjectFactory for Python.
    """

    def __init__(self, main_file_name='main.js', python_binary='node', additional_flags=None):
        """
        Initializes an instance of PythonProjectFactory with the given options.
...
_ALL_FACTORIES = {
    ...
    "javascript":JSProjectFactory(python_binary='node')
}
